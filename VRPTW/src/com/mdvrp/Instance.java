...
import com.GMGroup.Genetic.Accelerator;
...
public class Instance {
	...
	public static Instance getInstance()
	{
		if (instance!=null)
			...
			throw new NullPointerException("Istance hasn't been initialized.");
	}
	
	public static void setInstance(Parameters parameters)
	{
		instance = new Instance(parameters);
	}
	
	private Instance(Parameters parameters) 
	{
...
//	}
	...
	/**
	* Calculate the symmetric euclidean matrix of costs
	* This is the new method to do it
	*/
	public void calculateDistances() {
		distances = new double[customersNr + depotsNr][customersNr + depotsNr];
		for (int i = 0; i < customersNr + depotsNr - 1; ++i)
